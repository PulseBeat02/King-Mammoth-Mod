...
import pulsebeat_02.kingmammoth.item.KingMammothArmor;
...
public final class EventSubscriber {
	...
	public static void registerItems(Register<Item> event) {
		...
		items.add(KingMammothArmor.king_mammoth_boots);
		items.add(KingMammothArmor.king_mammoth_leggings);
		items.add(KingMammothArmor.king_mammoth_chestplate);
		items.add(KingMammothArmor.king_mammoth_crown);
