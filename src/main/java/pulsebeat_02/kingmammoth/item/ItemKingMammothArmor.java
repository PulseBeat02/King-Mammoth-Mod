...
public class ItemKingMammothArmor extends ItemArmor {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
		...
		if (player.inventory.armorItemInSlot(0).getItem().equals(KingMammothArmor.king_mammoth_boots)) { 
		...
		else if (player.inventory.armorItemInSlot(1).getItem().equals(KingMammothArmor.king_mammoth_leggings)) {
		...
		else if (player.inventory.armorItemInSlot(2).getItem().equals(KingMammothArmor.king_mammoth_chestplate)) {
			...
			player.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, 1000000, 200));
			player.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 1000000, 8));

		}
		
		else if (player.inventory.armorItemInSlot(3).getItem().equals(KingMammothArmor.king_mammoth_crown)) {
