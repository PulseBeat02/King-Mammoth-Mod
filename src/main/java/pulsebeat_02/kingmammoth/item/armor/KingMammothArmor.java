...
public class KingMammothArmor {
	
	public static ItemKingMammothArmor king_mammoth_crown = new ItemKingMammothArmor(KingMammothMaterials.mammoth_armor, EntityEquipmentSlot.HEAD, "king_mammoth_crown");
